...
beautiful.init("/home/magi/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessUp", function () awful.spawn("light -As 'sysfs/backlight/auto' 5")                end,
    ...
    -- awful.key({ }, "XF86AudioLowerVolume", function () awful.spawn("light -Us 'sysfs/backlight/auto' 5")                end,
    ...
    awful.key({ modkey },            "d",     function () awful.spawn("rofi -show run -show-icons") end,
              {description = "run prompt", group = "launcher"}),
...
awful.spawn("setxkbmap -option caps:escape") -- map caps to escape
